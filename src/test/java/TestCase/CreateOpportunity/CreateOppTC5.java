...
public class CreateOppTC5 extends CommonTests {

    @Test
    @Description // Save and Continue Button Functionality
    public void TC5_CreateOpp(){
        ...
        createOpportunity.clickMoreActionBtn();
        createOpportunity.clickSaveandContinueBtn();
    }
}
