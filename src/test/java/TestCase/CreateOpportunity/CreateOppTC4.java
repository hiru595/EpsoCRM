...
public class CreateOppTC4 extends CommonTests {

    @Test
    @Description //Cancel Opportunity Creation using "Cancel" button
    public void TC4_CreateOpp(){
        ...
        createOpportunity.clickCancelBtn();
    }
}
